            ...
            <CardHeader className="py-3 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:-top-2.5 transition-all duration-300">
                <div className="flex justify-between items-start">
                    <div className="space-y-1">
                        <h3 className="font-bold text-lg leading-tight text-gray-700">{hero.alias}</h3>
                ...
                <Badge variant="outline" className="w-fit text-xs bg-green-100 text-green-800 border-green-200">
                    {hero.team}
                </Badge>
            </CardHeader>

            <CardContent className="space-y-4">
                <p className="text-sm line-clamp-2 hover:line-clamp-none transition-all duration-200">
                    {hero.description}
                </p>
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="space-y-1">
                        ...
                        <Progress value={hero.speed * 10} className="h-2" activeColor="bg-purple-500" />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={hero.durability * 10} className="h-2" activeColor="bg-green-500" />
                    </div>
                </div>
                ...
                <div className="text-xs pt-2 border-t">First appeared: {hero.firstAppearance}</div>
            </CardContent>
        </Card>
    )
}